        ...
        <div className="space-y-8">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="mt-2">
                <a href="https://commission.nephele.in.th/example/tier-1" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">
                  ดูตัวอย่าง <span className="underline">คลิกที่นี่</span>
                </a>
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-2">
                <a href="https://nirvana-birthday-2025.nephele.in.th" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">
                  ดูตัวอย่าง <span className="underline">คลิกที่นี่</span>
                </a>
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-2">
                <a href="https://commission.nephele.in.th/example/tier-3" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">
                  ดูตัวอย่าง <span className="underline">คลิกที่นี่</span>
                </a>
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-2">
                <a href="https://commission.nephele.in.th/example/tier-4" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">
                  ดูตัวอย่าง <span className="underline">คลิกที่นี่</span>
                </a>
              </p>
            </div>
