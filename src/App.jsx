    ...
    <div className="py-12">
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg space-y-8 mb-8">
        <p className="text-gray-600">
          บริการพัฒนาเว็บไซต์สำหรับครีเอเตอร์ VTuber / เอเจนซี่ และโปรเจกต์แฟนคลับ
        </p>
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-600 mb-2">
                เหมาะสำหรับพอร์ตโฟลิโอ VTuber ส่วนตัว หรือแลนดิ้งเพจแบบง่าย  
                <a href="https://commission.nephele.in.th/example/tier-1" className="text-blue-500 hover:underline ml-2">
                  ชมตัวอย่างคลิกที่นี่
                </a>
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600 mb-2">
                เหมาะสำหรับเอเจนซี่ VTuber, VTuber อินดี้ หรือโปรเจกต์แฟนคลับที่ต้องการหน้าเว็บเพิ่มเติม  
                <a href="https://nirvana-birthday-2025.nephele.in.th" className="text-blue-500 hover:underline ml-2">
                  ชมตัวอย่างคลิกที่นี่
                </a>
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600 mb-2">
                สำหรับ VTuber และเอเจนซี่ที่ต้องการเว็บไซต์ระดับไฮเอนด์ที่ปรับแต่งได้อย่างเต็มที่  
                <a href="https://commission.nephele.in.th/example/tier-3" className="text-blue-500 hover:underline ml-2">
                  ชมตัวอย่างคลิกที่นี่
                </a>
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600 mb-2">
                สำหรับผู้ที่ต้องการคุณสมบัติเว็บไซต์ที่ไม่เหมือนใครนอกเหนือจากแพ็กเกจมาตรฐาน  
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc pl-6 text-gray-600 space-y-1">
              <li>การปรึกษาและการวางแผน</li>
              <li>การออกแบบและการอนุมัติต้นแบบ</li>
              <li>ขั้นตอนการพัฒนา</li>
              <li>การทดสอบและการแก้ไข</li>
              <li>ตรวจสอบและส่งมอบ</li>
            </ul>
          </div>
