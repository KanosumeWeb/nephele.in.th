      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg space-y-8 mb-8">
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="list-disc pl-6 text-gray-600 space-y-1">
                ...
                <li>Setup Domain และ Hosting ให้ (1,500 บาทต่อปีสำหรับ Hosting หากท่านไม่ชำระค่าบริการ จะทำให้เว็บไซต์ถูกระงับ และไม่รวมอยู่ในค่าบริการเริ่มต้น สำหรับ Domain Name จะคิดราคาตามจริง)</li>
              </ul>
            </div>

            <div>
              <h4 className="text-xl font-semibold mb-2">🔹 แพ็กเกจมาตรฐาน – 12,000 บาทขึ้นไป</h4>
              <p className="text-gray-600 mb-2">เหมาะสำหรับเอเจนซี่ VTuber, VTuber อินดี้ หรือโปรเจกต์แฟนคลับที่ต้องการหน้าเว็บเพิ่มเติม</p>
              <ul className="list-disc pl-6 text-gray-600 space-y-1">
                <li>เว็บไซต์หลายหน้า (หน้าแรก, เกี่ยวกับ, ตารางเวลา, แกลเลอรี, ติดต่อ)</li>
                <li>ธีมและการสร้างแบรนด์แบบกำหนดเอง</li>
                <li>เอฟเฟกต์แอนิเมชั่นพื้นฐาน (เอฟเฟกต์โฮเวอร์, การเปลี่ยนภาพแบบง่าย)</li>
                <li>การฝังสตรีม Twitch/YouTube</li>
                <li>การออกแบบที่เหมาะกับมือถือ</li>
                <li>Setup Domain และ Hosting ให้ (1,500 บาทต่อปีสำหรับ Hosting หากท่านไม่ชำระค่าบริการ จะทำให้เว็บไซต์ถูกระงับ และไม่รวมอยู่ในค่าบริการเริ่มต้น สำหรับ Domain Name จะคิดราคาตามจริง)</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600 mb-2">สำหรับ VTuber และเอเจนซี่ที่ต้องการเว็บไซต์ระดับไฮเอนด์ที่ปรับแต่งได้อย่างเต็มที่</p>
              <ul className="list-disc pl-6 text-gray-600 space-y-1">
                <li>เว็บไซต์ที่ปรับแต่งได้อย่างเต็มที่พร้อมแอนิเมชั่นและการโต้ตอบขั้นสูง</li>
                <li>การรวม API (YouTube, Twitch, Discord, Twitter)</li>
                <li>การตั้งค่า E-commerce (สำหรับการขายสินค้า)</li>
                <li>การรวมตารางเวลาขั้นสูงพร้อมการอัปเดตสด</li>
                <li>การปรับแต่ง SEO เพื่อการมองเห็นที่ดีขึ้น</li>
                <li>แผงควบคุมผู้ดูแลระบบที่สร้างขึ้นเองสำหรับการจัดการเนื้อหา</li>
                <li>Setup Domain และ Hosting ให้ (1,500 บาทต่อปีสำหรับ Hosting หากท่านไม่ชำระค่าบริการ จะทำให้เว็บไซต์ถูกระงับ และไม่รวมอยู่ในค่าบริการเริ่มต้น สำหรับ Domain Name จะคิดราคาตามจริง)</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600 mb-2">สำหรับผู้ที่ต้องการคุณสมบัติเว็บไซต์ที่ไม่เหมือนใครนอกเหนือจากแพ็กเกจมาตรฐาน</p>
              <ul className="list-disc pl-6 text-gray-600 space-y-1">
                <li>ระบบที่สร้างขึ้นตามความต้องการ (พอร์ทัลสมาชิก, คุณสมบัติการโต้ตอบกับแฟนๆ ฯลฯ)</li>
                <li>ระบบแบ็กเอนด์ที่ซับซ้อน</li>
                <li>การสร้างแบรนด์และแอนิเมชั่น VTuber ที่เป็นเอกลักษณ์</li>
                <li>Setup Domain และ Hosting ให้ (1,500 บาทต่อปีสำหรับ Hosting + Domain Name หากท่านไม่ชำระค่าบริการ จะทำให้เว็บไซต์ถูกระงับ และไม่รวมอยู่ในค่าบริการเริ่มต้น)</li>
              </ul>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-600 mb-2">เพิ่มประสิทธิภาพเว็บไซต์ของคุณด้วย</p>
            <ul className="list-disc pl-6 text-gray-600 space-y-1">
              <li>Maintenance และอัปเดตเว็บไซต์ (ฟรีสำหรับ 3 เดือนแรกหลังส่งมอบ ไม่จำเป็นต้องชำระหากไม่ต้องการ แต่หากไม่ชำระจะไม่มีการดูแลให้หลังสิ้นสุด สิ่งนี้รวมถึงการแก้ปัญหาต่างๆที่พบ) – 3,000 บาท/ปี</li>
              <li>เร่งงาน (เสร็จภายใน 5-7 วัน) – +50% จากราคา</li>
            </ul>
          </div>

          <div>
            <h3 className="text-2xl font-semibold text-blue-400 mb-4">📝 ขั้นตอนการทำงาน</h3>
            <ul className="list-disc pl-6 text-gray-600 space-y-1">
              <li>การปรึกษาและการวางแผน – พูดคุยเกี่ยวกับข้อกำหนดและขอบเขตที่ต้องการ</li>
              <li>การออกแบบและการอนุมัติต้นแบบ – ร่างรูปแบบเว็บไซต์</li>
              <li>ขั้นตอนการพัฒนา – การเขียนโค้ดและการสร้างฟังก์ชันการทำงานของเว็บไซต์</li>
              <li>การทดสอบและการแก้ไข – ตรวจสอบให้แน่ใจว่าการทำงานราบรื่น</li>
              <li>ตรวจสอบและส่งมอบ – ชำระเงินในส่วนที่เหลือและปลดล็อค Popup ที่เขียนว่า "อยู่ในระหว่างการพัฒนาโดย Nephele Interactive และยังไม่ได้ชำระค่าบริการ หากคุณเป็นผู้ชม ไม่จำเป็นต้องดำเนินการใดๆ หากคุณเป็นเจ้าของ Website กรุณาติดต่อ Nephele Interactive"</li>
            </ul>
          </div>

          <div>
            <h3 className="text-2xl font-semibold text-blue-400 mb-4">⏳ ระยะเวลาโดยประมาณ</h3>
            <ul className="list-disc pl-6 text-gray-600 space-y-1">
              <li>พื้นฐาน: 1-2 สัปดาห์</li>
              <li>มาตรฐาน: 2-4 สัปดาห์</li>
              <li>พรีเมียม: 4-6 สัปดาห์</li>
              <li>กำหนดเอง: แตกต่างกันไปตามความซับซ้อน</li>
            </ul>
          </div>

          <div>
            <h3 className="text-2xl font-semibold text-blue-400 mb-4">💳 เงื่อนไขการชำระเงิน</h3>
            <ul className="list-disc pl-6 text-gray-600 space-y-1">
              <li>50% ล่วงหน้า, 50% เมื่อเสร็จสิ้น</li>
              <li>วิธีการชำระเงิน: โอนเงินผ่านธนาคาร เท่านั้น</li>
            </ul>
          </div>

          <div>
            <h3 className="text-2xl font-semibold text-blue-400 mb-4">📩 ติดต่อสำหรับคอมมิชชั่นและสอบถาม</h3>
